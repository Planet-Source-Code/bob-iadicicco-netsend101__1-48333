...
'Change this to update the QuickRegAdd & QuickRegGet paths
Private Const sCompanyName As String = "LostKender"

'Form_Load Example
'Me.Left = QuickRegGet("frm", "Left", 1000)
'Me.Top = QuickRegGet("frm", "Top", 1000)
'Me.Width = QuickRegGet("frm", "Width", 6500)
'Me.Height = QuickRegGet("frm", "Height", 6500)
'Me.WindowState = QuickRegGet("frm", "WindowState", 0)
'
'Form_Unload Example
'If Me.WindowState = 0 Then
'    QuickRegAdd "frm", "Left", Me.Left
'    QuickRegAdd "frm", "Top", Me.Top
'    QuickRegAdd "frm", "Width", Me.Width
'    QuickRegAdd "frm", "Height", Me.Height
'End If
'If Me.WindowState <> 1 Then
'    QuickRegAdd "frm", "WindowState", Me.WindowState
'End If
...
' Changed by Lost Kender                  LostKender@hotmail.com
'
...
Public Sub QuickRegAdd(sSection As String, sKey As String, vSetting As Variant)
'Creates or Updates
'HKEY_CURRENT_USER\Software\[sCompanyName]\[App.Title]\[sSection]\[sKey]
'to [sSetting]
    Dim sRegPath As String
    Dim sRegPathFull As String
    Dim lngRootKey As Long
    
    sRegPath = "Software\" + sCompanyName
    sRegPathFull = "Software\" + sCompanyName + "\" + App.Title + "\" + sSection
    lngRootKey = HKEY_CURRENT_USER

    If Not regDoes_Key_Exist(lngRootKey, sRegPathFull) Then
        ' create the main key and the first sub key
        regCreate_A_Key lngRootKey, sRegPath
        regCreate_A_Key lngRootKey, sRegPathFull
    End If
    regCreate_Key_Value lngRootKey, sRegPathFull, sKey, vSetting
End Sub

Public Function QuickRegGet(sSection As String, sKey As String, vDefault As Variant) As Variant
'Returns 'HKEY_CURRENT_USER\Software\[sCompanyName]\[App.Title]\[sSection]\[sKey]
'or returns [vDefault] if not there
    Dim sRegPathFull As String
    Dim lngRootKey As Long
    ...
    QuickRegGet = regQuery_A_Key(lngRootKey, sRegPathFull, sKey)
    If Len(QuickRegGet) = 0 Then QuickRegGet = vDefault
End Function
